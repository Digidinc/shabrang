...
![The Persian Rug](/images/books/liquid-fortress/19-nigredo/page-07.png)
...
1.  **Unique Hash:** The pattern of knots is a unique "Signature." It cannot be counterfeited because it is tied to the kinetic memory of the weaver.
2.  **Decentralized Storage:** Rugs are portable. When the city (The Server) burns, the data (The Rug) is carried away on a horse.
3.  **Immutable Data:** The symbols encoded in the rug—the [[simurgh-miniature|Simurgh]], the Rose, the Tree of Life—are "Hard-Coded" into the fabric. They preserve the identity of the swarm even in exile.

### High-Fidelity Survival
The rug is history's most durable **Cold Storage**. It is a way to pass the "Private Keys" of Persian identity to the next generation without needing a state, a library, or a centralized database.

**Axiom:** The pattern survives the fire because the pattern is the fire.
