...
The Qanat proves that true survival comes from **Liquid Architecture**. By moving the infrastructure into the [[andaruni|Andaruni]] (the hidden world), the civilization ensured its Level 1 survival even when the political Level 1 (the empire) was in chaos.

**Axiom:** The most durable network is the one that cannot be seen from the sky.
