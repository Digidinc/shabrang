      ...
      <div className="prose prose-invert max-w-none space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-frc-text-dim leading-relaxed">
            By accessing and using shabrang.ca (&quot;the Website&quot;), you accept and agree
        ...
        <section className="space-y-4">
          ...
          <p className="text-frc-text-dim leading-relaxed">
            The Website presents literary, artistic, and philosophical content including
            &quot;The Liquid Fortress&quot; book and related materials. The content is:
          </p>
          <ul className="list-disc list-inside text-frc-text-dim space-y-2 ml-4">
            <li>Provided for educational and cultural purposes</li>
            <li>Subject to revision and updates</li>
            <li>Creative and philosophical in nature</li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-frc-text-dim leading-relaxed">
            All content on this Website, including text, articles, artwork, and media,
            is the intellectual property of Kay Hermes unless otherwise noted.
          </p>
        ...
        <section className="space-y-4">
          <h2 className="text-lg text-frc-text font-medium">4. No Warranties</h2>
          <p className="text-frc-text-dim leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-lg text-frc-text font-medium">5. Limitation of Liability</h2>
          <p className="text-frc-text-dim leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-lg text-frc-text font-medium">6. External Links</h2>
          <p className="text-frc-text-dim leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-lg text-frc-text font-medium">7. Modifications</h2>
          <p className="text-frc-text-dim leading-relaxed">
